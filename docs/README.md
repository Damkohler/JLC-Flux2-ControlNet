...
This documentation covers JLC Flux2 ControlNet Release 1.0.1. It is arranged as a progression: new users can begin with installation and an included workflow, while advanced users can continue into node contracts, cache behavior, architecture, and validation history.
...
| Label | Meaning |
|---|---|
| **Stable** | A validated Release 1.0.1 path intended for normal use within the documented scope. |
...
1. Current Release 1.0.1 source code and package registration
2. Current user-facing node inputs, outputs, and validation errors
3. Included Release 1.0.1 workflows
